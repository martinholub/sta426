...
#### Answer 4.
We adopt the same approach as for [Answer 2.](#Answer 2) and we loop over all rows.

**Q: Shouldn't perhaps use var.equal = TRUE?, paired = TRUE?**
