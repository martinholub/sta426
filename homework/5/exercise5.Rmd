...
We look at the distribution and see that it allows for very high values of standard deviation (max: `r max(sd)`, min: `r min(sd)`), this is because chi-squared has support on (0,+ \infty).
