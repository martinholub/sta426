...
```
*This gene shows lowest p.value for the "present10-absent10" contrast. These are the first 4 bars in the plot and we can visually confirm that the logFC values are indeed different. We may plot some other random gene and check whether the difference (between the frist two column pairs) decreases.*
...
*Q: How to manually compute log2FC?*
